...
// variables for the hours that will be displayed
var nineAm = $("#9am");
var tenAm = $("#10am");
var elevenAm = $("#11am");
var twelvePm = $("#12pm");
...
$(document).ready(function(){
  ...
  // this will allow info to be stored to the local storage
  ...
  // Button that allows the user to clear the page
